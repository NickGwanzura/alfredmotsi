...
export async function POST(
  ...
  const html = `
    ...
    <head>
      ...
      <style>@font-face{font-family:'Mona Sans';src:url('${BRAND_FONT_URL}') format('woff2');font-weight:200 900;font-style:normal}</style>
    </head>
      <body style="margin:0;padding:0;font-family:'Mona Sans',Arial,sans-serif;background:#f4f6f8;">
                    ...
                    <tbody>
                      ${[
                        ...
                        <tr style="border-bottom:1px solid #e0e0e0;">
                          ...
                          <td style="padding:8px 12px;font-size:12px;color:#161616;font-family:'Mona Sans',Arial,sans-serif;">${e(r[1])} ${e(r[2])}</td>
                        </tr>
                      `).join('')}
                    </tbody>
                  </table>
