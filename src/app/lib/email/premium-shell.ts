...
<style>@font-face{font-family:'Mona Sans';src:url('${BRAND.website}/fonts/MonaSansVariable.woff2') format('woff2');font-weight:200 900}</style></head>
<body style="margin:0;padding:0;background:${BRAND.surface};font-family:'Mona Sans',Arial,sans-serif;color:${BRAND.text};">
